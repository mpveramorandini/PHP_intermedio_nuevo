...
//  mysqli_query($conexion_db, "INSERT INTO alumnos VALUES (DEFAULT,'$nombre_alumno','$apellido_alumno',
//     '$nombre_img', '$descripcion_alumno', '$estado_alumno')");
//  header("Location:cargar.php?ok");
//   } else {
//  header("Location:cargar.php?error_codigo");  } mysqli_close($conexion_db);
